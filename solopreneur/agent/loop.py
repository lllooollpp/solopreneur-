...
from solopreneur.agent.context import ContextBuilder
from solopreneur.agent.compaction import CompactionEngine
from solopreneur.agent.tools.registry import ToolRegistry
from solopreneur.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from solopreneur.agent.tools.shell import ExecTool
from solopreneur.agent.tools.web import WebSearchTool, WebFetchTool
from solopreneur.agent.tools.message import MessageTool
from solopreneur.agent.tools.spawn import SpawnTool
from solopreneur.agent.subagent import SubagentManager
...
class AgentLoop:
    ...
    def __init__(
        ...
        # 延迟导入以避免循环依赖
        from solopreneur.roles.manager import RoleManager
    ...
    def _register_default_tools(self) -> None:
        ...
        from solopreneur.agent.tools.delegate import DelegateTool
