        ...
        smoke_tests = [
            {
                ...
                "command": "python -c \"from nanobot.api.main import app; print('OK')\"",
                "expected": "OK"
            },
            {
            ...
            },
            {
                ...
                "command": "python -c \"from nanobot.providers.litellm_provider import LiteLLMProvider; print('OK')\"",
                "expected": "OK"
            },
            {
                "name": "Config file exists",
                "command": "python -c \"from pathlib import Path; import os; p = Path.home() / '.nanobot' / 'config.json'; print('EXISTS' if p.exists() else 'NOT_FOUND')\"",
                "expected": "EXISTS"
            },
            {
